                        ...
                        <tr>
                            ...
                            <td>
                                <picture>
                                    ...
                                    <img src="<?= base_url('assets/img/') . $b['image'] ?>" class="img-fluid img-thumbnail" alt="...">

                                </picture>
                            </td>
                            <td>
                                <a href="<?= base_url('ubahBuku/') . $b['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
